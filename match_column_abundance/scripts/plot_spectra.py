...
earth = smart.readsmart.Trnst('../smart_outputs/earth/case_6666_25000cm.trnst')
# observation_flux = observation.absrad
earth_flux = earth.tdepth * 1e6
earth_wl = earth.lam

bulge = smart.readsmart.Trnst('../smart_outputs/cold_trap_0_1/case_6666_25000cm.trnst')
bulge_flux = bulge.tdepth * 1e6
bulge_wl = bulge.lam
